...
cancer.unfiltered.p <- list(); gender.unfiltered.p <- list(); cangen.unfiltered.p <- list()
cancer.cv.p <- list(); gender.cv.p <- list(); cangen.cv.p <- list()
cancer.cvmn.p <- list(); gender.cvmn.p <- list(); cangen.cvmn.p <- list()
