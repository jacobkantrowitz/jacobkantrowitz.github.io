...
setwd("/protected/projects/pulmarray/Allegro/COPD_Cancer/experiments/Expmt_0036_Projection_LM_Signatures_toAllegro/")
...
genesets <- list(atf4c1=atf4Cluster1, atf4c2=atf4Cluster2, emt=as.character(emt_genes$EMT_Genes), lmc1=as.character(lmcluster1$GeneSet), lmc2=as.character(lmcluster2$GeneSet))
