...
# Goal(s) for the day:
# Run simple copd*cancer (no covariates) model
...
covars.cancerCOPD <- list("FinalCaDXc", "COPD_EM_Bronchitisc", "FinalCaDXc*COPD_EM_Bronchitisc")
					
results <- analyze_lists(covars.cancerCOPD, exprData)
