...
# this is the weighted voting algorithm from Golum et al., Science, 1999
# this was written by Adam Gower and was downloaded from the pulmonomics wiki
# this function has not been updated to handle expressionSets
